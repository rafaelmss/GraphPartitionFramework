package br.edu.unifei.mestrado.commons.lo;
 ...
 * 
 */
public class EdgesMerged implements Iterable<TempEdge> {
	...
	public Iterator<TempEdge> iterator() {
		return new EdgesMergedIterator();
	}
